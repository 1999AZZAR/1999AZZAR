...
function updateLanguage(lang) {
  const map = {
    ...
    contactRatePaymentOption0: 'payment-option-0',
    ...
    pricingCalculatorTitle: 'pricing-calculator-title',
    pricingNegotiable: 'pricing-negotiable',
    pricingMinimum250Note: 'pricing-minimum-note',
    pricingRateCalculatorTitle: 'pricing-rate-calculator-title',
    pricingHoursLabel: 'pricing-hours-label',
    pricingPaymentLabel: 'pricing-payment-label',
    pricingConsultationSeparate: 'pricing-consultation-separate',
    pricingCurrencyLabel: 'pricing-currency-label',
    pricingCalculateBtn: 'pricing-calculate-btn',
    pricingResetBtn: 'pricing-reset-btn',
    pricingGenerateReceiptBtn: 'pricing-generate-receipt-btn',
    pricingPaymentBreakdown: 'pricing-payment-breakdown',
    pricingProjectDescriptionLabel: 'pricing-project-description-label',
    pricingProjectDescriptionOptional: 'pricing-project-description-optional',
    pricingInvalidHours: 'pricing-invalid-hours',
    pricingResultRate: 'pricing-result-rate',
    pricingResultTotal: 'pricing-result-total',
    pricingResultDays: 'pricing-result-days',
    pricingConsultationFeesPaidSeparately: 'pricing-consultation-fees-paid-separately',
    pricingConsultationIncluded: 'pricing-consultation-included',
    pricingPaymentProjectLabel: 'pricing-payment-project-label',
    pricingPaymentConsultationLabel: 'pricing-payment-consultation-label',
    pricingWhyTitle: 'pricing-why-title',
    pricingWhyDesc: 'pricing-why-desc',
    pricingBenefit1: 'pricing-benefit-1',
    pricingBenefit2: 'pricing-benefit-2',
    pricingBenefit3: 'pricing-benefit-3',
    pricingBenefit4: 'pricing-benefit-4',
    pricingResultsTitle: 'pricing-results-title',
