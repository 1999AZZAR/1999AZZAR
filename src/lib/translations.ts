export const translations = {
  "en": {
    ...
    "expMediaEngineerTitle": "full stack engineer, pt. jejaring media arus utama",
    "expMediaEngineerDate": "2026/08 — PRESENT",
    "expMediaEngineerLocation": "Jakarta (Hybrid)",
    "expMediaEngineer1": "Built and maintained a multi-service media platform using Go, Gin, Bun ORM, PostgreSQL, React, Astro, Tailwind CSS, Flutter, and Cloudflare infrastructure across web, admin, portal, mobile, and API services.",
    "expMediaEngineer2": "Designed and implemented database connectivity hardening for Cloud Run API connected to Neon PostgreSQL, including connection pool tuning, timeout handling, transient error classification, safe 503 responses, and staging min-instances optimization.",
    "expMediaEngineer3": "Diagnosed intermittent production database timeouts by correlating Cloud Run runtime behavior, Neon PostgreSQL connectivity, IPv4/IPv6 paths, connection pooling, cold-start scenarios, provider documentation, and read-only audits.",
    "expMediaEngineer4": "Established a structured staging-to-production delivery workflow using GitHub, pull requests, GitHub Actions, Cloud Run, Cloudflare Workers, and Cloudflare Pages, with repository parity checks, smoke testing, and rollback-aware release practices.",
    "expMediaEngineer5": "Improved system reliability and operational safety by implementing secure credential management with an encrypted vault, staging-only intensive testing, no-blind-retry policies for database writes, safe draft cleanup, and SSR resilience.",
    "expLeadDevTitle": "lead developer, pt. turga berkah kubra",
    "expLeadDevDate": "2026/01 — PRESENT",
    "expLeadDevLocation": "Remote/Onsite",
    "expLeadDev1": "Lead full-stack web development projects, architecting scalable solutions from concept to deployment.",
    "expLeadDev2": "Integrate AI/ML models into production applications, enhancing automation and decision-making capabilities.",
    "expLeadDev3": "Manage DevOps infrastructure, implementing CI/CD pipelines and containerized deployments.",
    "expLeadDev4": "Oversee development team, conducting code reviews and ensuring code quality standards.",
    "expLeadDev5": "Collaborate with stakeholders to define technical requirements and project roadmaps.",
    ...
    "contactEmailValue": "azzar.budi@gmail.com",
    ...
    "pricingMinimum250Note": "A minimum of $500 applies per project to keep scope and expectations clear and avoid confusion on small engagements.",
    ...
    "contactMinProject": "MINIMUM PROJECT VALUE: $500_USD",
  ...
  "id": {
    ...
    "expMediaEngineerTitle": "full stack engineer, pt. jejaring media arus utama",
    "expMediaEngineerDate": "2026/08 — SEKARANG",
    "expMediaEngineerLocation": "Jakarta (Hybrid)",
    "expMediaEngineer1": "Membangun dan memelihara platform media multi-service menggunakan Go, Gin, Bun ORM, PostgreSQL, React, Astro, Tailwind CSS, Flutter, dan infrastruktur Cloudflare di seluruh layanan web, admin, portal, mobile, dan API.",
    "expMediaEngineer2": "Merancang dan mengimplementasikan penguatan konektivitas database untuk API berbasis Cloud Run ke Neon PostgreSQL, mencakup tuning connection pool, timeout handling, klasifikasi error transien, respons aman 503, dan optimasi staging min-instances.",
    "expMediaEngineer3": "Mendiagnosa timeout database produksi intermiten dengan mengorelasikan perilaku runtime Cloud Run, konektivitas Neon PostgreSQL, jalur IPv4/IPv6, connection pooling, skenario cold-start, dan audit database read-only.",
    "expMediaEngineer4": "Membangun alur delivery terstruktur dari staging ke produksi menggunakan GitHub PR, GitHub Actions, Cloud Run, Cloudflare Workers, dan Cloudflare Pages dengan verifikasi paritas repositori, smoke test, dan rollback-aware deployment.",
    "expMediaEngineer5": "Meningkatkan keandalan sistem dan keamanan operasional melalui manajemen kredensial terenkripsi (vault), pengujian intensif di staging, kebijakan no-blind-retry untuk operasi write, pembersihan draf aman, dan ketahanan SSR.",
    "expLeadDevTitle": "pengembang utama, pt. turga berkah kubra",
    "expLeadDevDate": "2026/01 — SEKARANG",
    "expLeadDevLocation": "Remote/Onsite",
    "expLeadDev1": "Memimpin proyek pengembangan web full-stack, merancang solusi skalabel dari konsep hingga deployment.",
    "expLeadDev2": "Mengintegrasikan model AI/ML ke dalam aplikasi produksi, meningkatkan otomasi dan kemampuan pengambilan keputusan.",
    "expLeadDev3": "Mengelola infrastruktur DevOps, mengimplementasikan pipeline CI/CD dan deployment terkontainerisasi.",
    "expLeadDev4": "Mengawasi tim pengembangan, melakukan review kode dan memastikan standar kualitas kode.",
    ...
    "pricingMinimum250Note": "Minimum $500 per proyek diterapkan agar ruang lingkup dan ekspektasi jelas dan menghindari kebingungan pada proyek kecil.",
    ...
    "contactMinProject": "NILAI PROYEK MINIMUM: $500_USD",
