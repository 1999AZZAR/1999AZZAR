export const translations = {
  "en": {
    ...
    "about": "About",
    "summary": "Summary",
    "summaryText": "Expert freelance IoT developer and full-stack engineer with 5+ years experience specializing in Arduino programming, Python, JavaScript, AI/ML, and embedded systems. Remote work available worldwide. Proficient in modern web frameworks (React, Node.js, Flask, Django) and microcontroller platforms (ESP32, STM32). Skilled in DevOps, AWS cloud, and advanced control systems. Multilingual developer fluent in English, Indonesian, Arabic, and Javanese. <a href='/services' class='internal-link'>Explore my services</a> or <a href='/contact' class='internal-link'>view pricing</a> for freelance projects.",
